...
\begin{abstract}
	\noindent
	These lecture notes are based on the first few chapters of Robert A. Adams's \emph{Calculus: A Complete Course}, \cite{Adams2013}, wherein recommended exercises are also found. All the material covered can be found in there, though the exposition might sometimes be altered.
	In particular these notes will focus more on the theoretical, whilst the student who prefers practical computation is encouraged to consult the textbook.
	
	Occasionally there will be small sections marked as `exercise'.
	These are examples or simpler proofs which are left for the student to think about on their own.  \blfootnote{Last updated \today.}
